...
def CreateDataFrame():
    try:
        ...
        sheet.write(0, 82,'DOOR Atrialmoothing',title_style)
        sheet.write(0, 84,'DOOR Activity Amplitude',title_style)
        sheet.write(0, 83,'DOOR Rate Threshold',title_style)
        ...
        sheet.write(0, 123, 'DOOR Sensor Rate', title_style)
